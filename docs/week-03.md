...
|---|---|---|---|
| 사용자 Who |스마트폰 사용자 |학생|대학
| 상황 When/Where |잠들기 전|온라인 강의를 들을 때 |특정 건물이나 강의실을 찾을 때|
| 페인포인트 What — 무엇이 **얼마나** |입면 장애와 수면 분절|소리로 강의를 들어야하는 상황에서 자막이 없을 때|가본 적 없는 건물이나 강의실을 가야하는 상황에 처했을 때|
| 성공 기준 Done |입면과 수면의 질을 도와주  |  |  |
